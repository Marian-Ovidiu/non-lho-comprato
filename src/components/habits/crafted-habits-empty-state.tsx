...
export function CraftedHabitsEmptyState() {
  ...
  const habitIdeas = [
    { icon: "coffee" as const, name: t.habitForm.exampleCoffee, amount: "4€" },
    { icon: "cig" as const, name: t.habitForm.exampleCigarettes, amount: "6€" },
    { icon: "glass" as const, name: t.habitForm.exampleAperitivo, amount: "12€" },
    { icon: "fork" as const, name: t.habitForm.exampleDelivery, amount: "15€" },
  ];
  ...
  return (
    <section className="-mx-4 px-[var(--sp-page-x)] py-16 text-center sm:-mx-6 lg:-mx-8">
      ...
      <p className="mx-auto mt-3 max-w-sm text-sm text-ink-3">
        {t.habitForm.createDesc}
      </p>

      <div className="mt-8 text-left">
        <Label className="mb-3 block">{t.habitForm.categoryLabel}</Label>
